package uk.gov.hmcts.reform.ingestion.camel.route;

import static org.apache.commons.lang.WordUtils.uncapitalize;
import static uk.gov.hmcts.reform.ingestion.camel.util.MappingConstants.BLOBPATH;
import static uk.gov.hmcts.reform.ingestion.camel.util.MappingConstants.CSVBINDER;
import static uk.gov.hmcts.reform.ingestion.camel.util.MappingConstants.DIRECT_ROUTE;
import static uk.gov.hmcts.reform.ingestion.camel.util.MappingConstants.FILE_NAME;
import static uk.gov.hmcts.reform.ingestion.camel.util.MappingConstants.ID;
import static uk.gov.hmcts.reform.ingestion.camel.util.MappingConstants.INSERT_SQL;
import static uk.gov.hmcts.reform.ingestion.camel.util.MappingConstants.MAPPER;
import static uk.gov.hmcts.reform.ingestion.camel.util.MappingConstants.MAPPING_METHOD;
import static uk.gov.hmcts.reform.ingestion.camel.util.MappingConstants.PROCESSOR;
import static uk.gov.hmcts.reform.ingestion.camel.util.MappingConstants.ROUTE;
import static uk.gov.hmcts.reform.ingestion.camel.util.MappingConstants.ROUTE_DETAILS;
import static uk.gov.hmcts.reform.ingestion.camel.util.MappingConstants.TABLE_NAME;
import static uk.gov.hmcts.reform.ingestion.camel.util.MappingConstants.TRUNCATE_SQL;
...
import uk.gov.hmcts.reform.ingestion.camel.processor.ArchiveAzureFileProcessor;
import uk.gov.hmcts.reform.ingestion.camel.processor.ExceptionProcessor;
import uk.gov.hmcts.reform.ingestion.camel.processor.FileReadProcessor;
import uk.gov.hmcts.reform.ingestion.camel.processor.HeaderValidationProcessor;
import uk.gov.hmcts.reform.ingestion.camel.route.beans.RouteProperties;
import uk.gov.hmcts.reform.ingestion.camel.service.EmailService;
